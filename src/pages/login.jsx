            ...
            <div className="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
                ...
                <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                    <input 
                        ...
                        required 
                        className="bg-red-100 border border-gray-300 rounded-md px-4 py-2 text-lg focus:outline-none focus:ring-2 focus:ring-red-400" 
                    />
                    <input 
                        type="password" 
                    ...
                    <button 
                        ...
                        className="bg-red-600 text-white py-2 rounded-md hover:bg-red-700 transition disabled:bg-red-300"
                    >
                        Log in
                    </button>
                </form>
